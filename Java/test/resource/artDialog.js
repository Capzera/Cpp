...
(function(){
	...
	$.doc = function(win){
		...
		return {
			...
			top: Math.max(dd.scrollTop, db.scrollTop)+200				// 被滚动条卷去的文档高度
		};
	};
...
$.fn.dialog = function(options, yesFn, noFn){
	...
	if (document.compatMode === 'BackCompat' && data.content!=undefined){
