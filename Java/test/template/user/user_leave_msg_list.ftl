...
<table width="996" align="center" border="0" cellSpacing="0" cellPadding="0" bgColor="#FFFFFF">
  <tbody>
  <tr>
        ...
        <tr>
          <td height="39" width="937">
            <table border="0" cellSpacing="0" cellPadding="0" width="996" align="center">
              <tbody>
              <tr>
                <td width="50" align="center"><a class="dh_14px" href="${base}/index">首页</a>
               </td>
...
<table width="996" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td>
	              <table width="100%" border="0" cellspacing="0" cellpadding="0">
		              <tr>
		                ...
		                <td width="94%" valign="bottom"><span class="STYLE1">教师留言列表</span></td>
		              </tr>
	              </table>
            </td>
            <td align="right" style="text-indent:5px;">
            	  <a href="${base}/user/leave_msg/add"><span class="STYLE1" style="color:white"><strong>我要留言</strong></span></a>
            </td>
         </tr>
        </table></td>
      </tr>
  ...
  <tr>
    <td class="list">
         ...
         <form action="${base}/user/leave_msg/list" method="post" id="listForm">
			          ...
			          <#list msgList as list>
							<tr>
									    <td width="4%" height="20" bgcolor="#FFFFFF" style="border-right:0px;">
						       		  	...
						       		  	<td bgcolor="#FFFFFF" class="STYLE19" style="width:300px;"><div align="left">${list.content}</div></td>
