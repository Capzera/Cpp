					            ...
					            <td>
					            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
						              <tr>
						                ...
						                <td width="94%" valign="bottom"><span class="STYLE1"> 文档分类列表</span></td>
						              </tr>
					            	</table>
					        		</td>
					          	<td>
					            	<div align="right"><span class="STYLE1">
					              		<input type="checkbox" name="checkbox11" id="checkbox11" class="selectAll"/>全选&nbsp;&nbsp;
					              			...
					              			<a href="${base}/admin/category/input" style="color:#E1E2E3">添加</a>&nbsp; 
  ...
  <tr>
    <td class="list">
    	<div style="font-size:13px;">
         	...
         	<form action="${base}/admin/category/list" method="POST" id="listForm">
							        ...
							        <td width="4%" height="20" bgcolor="d3eaef">
								        <div align="center">
								          <input type="checkbox" name="checkbox" id="checkbox" class="selectAll" />								          
											...
											<td bgcolor="d3eaef" class="STYLE6"><div align="LEFT" style="padding-left:25px;"><span class="STYLE10">编号</span></div></td>
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">分类名称</span></div></td>
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">是否显示</span></div></td>
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">创建时间</span></div></td>	
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">层数</span></div></td>								
								          ...
								          <input type="checkbox" name="checkbox" id="checkbox" class="record_id"  value="${list.SID}"/>
											...
											<td bgcolor="#FFFFFF" class="STYLE19">
												<div align="LEFT" style="padding-left:25px;">
												   <#if list.LEVEL gt 0>
												   		<span style="padding-left:${(list.LEVEL-1)*25}px">|__${list.SID}</span>
												   		<#else>
												   			 ${list.SID}
												   </#if>
												</div>
											...
											<td bgcolor="#FFFFFF" class="STYLE19"><div align="center">${list.c_TIME?string("yyyy-MM-dd HH:mm:ss")}</div></td>			
											...
											<td bgcolor="#FFFFFF" class="STYLE19">
											<div align="center">
												<img src="${base}/resource/images/edit.gif"> <a href="${base}/admin/category/edit/${list.SID}" class="edit" id="edit_${list_index}">编辑</a>&nbsp;
												<img src="${res}/images/del.gif"> <a href="javascript:void(0)" ref="${base}/admin/category/del" <#if list.children?size gt 0>disabled</#if> class="delete" id="${list.SID}">删除</a>
											</div>
									</td>
						</tr>
