...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					          	...
					          	<td>
					            	<div align="right"><span class="STYLE1">
					              		<input type="checkbox" name="checkbox11" id="checkbox11" class="selectAll"/>全选&nbsp;&nbsp;
					              			...
					              			<a href="${base}/admin/user/add" style="color:#E1E2E3">导入用户</a>&nbsp; 
					          				<img src="${res}/images/add.gif" width="10" height="10" /> 
					              			<a href="${base}/admin/user/input" style="color:#E1E2E3">添加</a>&nbsp; 
					              		<img src="${res}/images/del.gif" width="10" height="10" /> 
					              			<a href="javascript:void(0)" id="delAll" ref="${base}/admin/user/deleteAll" style="color:#E1E2E3">删除</a>&nbsp;&nbsp;
					              		<img src="${res}/images/edit.gif" width="10" height="10" /> 
					              			<a href="${base}/admin/user/search_input" id="search" ref="${base}/emp_mgr/search_input" style="color:#E1E2E3">查询</a>&nbsp;</span><span class="STYLE1"> &nbsp;</span>
					      				</div>
					  					</td>
				          </tr>
			      	</td>
  ...
  <tr>
    <td class="list">
         	...
         	<form action="${base}/admin/user/list" method="POST" id="listForm">
							        ...
							        <td width="4%" height="20" bgcolor="d3eaef">
								        <div align="center">
								          <input type="checkbox" name="checkbox" id="checkbox" class="selectAll" />								          
											...
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">用户姓名</span></div></td>
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">登录名</span></div></td>
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">密码</span></div></td>	
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">用户类型</span></div></td>								
			       ...
			       <#list userList as user>
							<tr>
											<td width="4%" height="20" bgcolor="#FFFFFF" style="border-right:0px;">
										        <div align="center">
										          <input type="checkbox" name="checkbox" id="checkbox" class="record_id"  value="${user.SID}"/>
										        </div>
							       			</td>
											...
											<td bgcolor="#FFFFFF" class="STYLE19"><div align="center">${user.PASSWD}</div></td>
											<td bgcolor="#FFFFFF" class="STYLE19">
												<div align="center">
													<#if user.u_TYPE == '1'>
														管理员
											...
											<td bgcolor="#FFFFFF" class="STYLE19">
												<div align="center">
													...
													<img src="${res}/images/edit.gif"> <a href="${base}/admin/user/edit/${user.SID}" class="edit" id="edit_${user_index}">编辑</a>&nbsp;
													<img src="${res}/images/del.gif"> <a href="javascript:void(0)" ref="${base}/admin/user/delete" class="delete" id="${user.SID}">删除</a>
												</div>
											</td>
						</tr>
				 	</#list>
