...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					            ...
					            <td>
					            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
						              <tr>
						                ...
						                <td width="94%" valign="bottom"><span class="STYLE1">实验室信息列表</span></td>
						              </tr>
					            	</table>
					        		</td>
					          	<td>
					            	<div align="right"><span class="STYLE1">
					              		<input type="checkbox" name="checkbox11" id="checkbox11" class="selectAll"/>全选&nbsp;&nbsp;
					              			...
					              			<a href="${base}/admin/test/room/add" style="color:#E1E2E3">添加</a>&nbsp; 
  ...
  <tr>
    <td class="list">
         	...
         	<form action="${base}/admin/test/room/list" method="POST" id="listForm">
							        ...
							        <td width="4%" height="20" bgcolor="d3eaef">
								        <div align="center">
								          <input type="checkbox" name="checkbox" id="checkbox" class="selectAll" />								          
											...
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">座位数</span></div></td>	
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">软件设备</span></div></td>								
																	
										
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作</span></div></td>
					       </tr>
			       <#list testRoomList as list>
							<tr>
									<td width="4%" height="20" bgcolor="#FFFFFF" style="border-right:0px;">
								        <div align="center">
								          <input type="checkbox" name="checkbox" id="checkbox" class="record_id"  value="${list.SID}"/>
											...
											<td bgcolor="#FFFFFF" class="STYLE19"><div align="center">${list.SEATS}</div></td>			
											
										
											<td bgcolor="#FFFFFF" class="STYLE19">
												<div align="center">
												
													<#if list.SOFT_DEVICE?length gt 255 > ${list.SOFT_DEVICE[0..254]}
														<#else>
															${list.SOFT_DEVICE}
													</#if>
												</div>
											...
											<td bgcolor="#FFFFFF" class="STYLE19">
												<div align="center">
													<img src="${res}/images/edit.gif"> <a href="${base}/admin/test/room/edit/${list.SID}" class="edit" id="edit_${list_index}">编辑</a>&nbsp;
													<img src="${res}/images/del.gif"> <a href="javascript:void(0)" ref="${base}/admin/test/room/delete" class="delete" id="${list.SID}">删除</a>
												</div>
											</td>
						</tr>
				 	</#list>
