					            ...
					            <td>
					            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
						              <tr>
						                ...
						                <td width="94%" valign="bottom"><span class="STYLE1"> 报警器信息列表</span></td>
						              </tr>
					            	</table>
					        		</td>
					          	<td>
  ...
  <tr>
    <td class="list">
    	<div style="font-size:13px;">
         	<form action="${base}/admin/alarm/search" method="post" id="searchForm">
         		<table border=0 class="search">
         		   <tr>
         		   		<td>类型编号：
         		   			<input type="text" name="TYPE_NUMBER" VALUE="${alarm.TYPE_NUMBER}">
         		   		<td>
         		   		<td>名称：
         		   			<input type="text" name="NAME" VALUE="${alarm.NAME}">
         		   		<td>
         		   		<td>
         		   			<input type="submit" value=" 查找  ">
         		   		</td>
         		   		<td style="text-indent:10px;">
         		   			<a href="javascript:void(0);" ref="${base}/user/saleOrder/exportExcel" id="export">导出EXCEL</a>
         		   			<script>
         	...
         	<form action="${base}/article/list/${category.SID}" method="POST" id="listForm">
         	    <input type="HIDDEN" name="USE_STATUS" value="${alarm.USE_STATUS}">
         	    <input type="hidden" name="TYPE_NUMBER" value="${alarm.TYPE_NUMBER}">
         	    <input type="hidden" name="NAME" value="${alarm.NAME}">
							        ...
							        <td width="4%" height="20" bgcolor="d3eaef">
								        <div align="center">
								          <input type="checkbox" name="checkbox" id="checkbox" class="selectAll" />								          
											...
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类型编号</span></div></td>
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">名称</span></div></td>
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">登记时间</span></div></td>	
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">总数</span></div></td>								
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">已入库</span></div></td>								
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">已出库</span></div></td>								
										
											<td bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作</span></div></td>
					       </tr>
			       <#list alarmList as list>
							<tr>
									<td width="4%" height="20" bgcolor="#FFFFFF" style="border-right:0px;">
								        <div align="center">
								          <input type="checkbox" name="checkbox" id="checkbox" class="record_id"  value="${list.SID}"/>
											...
											<td bgcolor="#FFFFFF" class="STYLE19"><div align="center">${list.NAME}</div></td>
											<td bgcolor="#FFFFFF" class="STYLE19"><div align="center">${list.c_TIME}</div></td>			
											...
											<td bgcolor="#FFFFFF" class="STYLE19">
												<div align="center">
													${list.IN_STORE_AMOUNT!0}
												</div>
											</td>
											<td bgcolor="#FFFFFF" class="STYLE19">
												<div align="center">
													${list.OUT_STORE_AMOUNT!0}
												</div>
											</td>
											<td bgcolor="#FFFFFF" class="STYLE19">
											<div align="center">
												<img src="${res}/images/edit.gif"> <a href="${base}/admin/alarm/edit/${list.SID}" class="edit" id="edit_${list_index}">编辑</a>&nbsp;
												<img src="${res}/images/del.gif"> <a href="javascript:void(0)" ref="${base}/admin/alarm/del" class="delete" id="${list.SID}">删除</a>
											</div>
									</td>
						</tr>
				 	</#list>
